...
const createBusiness = async (name, email, password, logoBuffer, strip_imageBuffer, created_at, updated_at) => {
  try {
    const newBusiness = await businessService.createBusiness(name, email, password, logoBuffer, strip_imageBuffer, created_at, updated_at);
    return newBusiness;
  } catch (err) {
...
const updateBusiness = async (id, name, email, password, logoBuffer, strip_imageBuffer, created_at, updated_at) => {
  try {
    const updatedBusiness = await businessService.updateBusiness(id, name, email, password, logoBuffer, strip_imageBuffer, created_at, updated_at);
